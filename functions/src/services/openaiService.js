...
function buildAssetLookupInstructions() {
  return [
    ...
    'Prioritize exact title + manufacturer operator/service/install/parts manuals first.',
    ...
    'Trusted manual libraries and reputable distributors are secondary sources only when exact-title official sources are unavailable or incomplete.',
    'Avoid generic homepages/manual hubs/distributor listings unless they explicitly reference the exact title.',
