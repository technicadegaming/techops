...
const defaults = {
  ...
  collections: {
    ...
    companies: 'companies', companyMemberships: 'companyMemberships', companyInvites: 'companyInvites', companyLocations: 'companyLocations', workers: 'workers', importHistory: 'importHistory', notifications: 'notifications', checklistTemplates: 'checklistTemplates', checklistSignoffEvents: 'checklistSignoffEvents'
  }
};
