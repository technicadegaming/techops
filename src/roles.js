...
export const canCreateTasks = (u) => isStaff(u);
export const canEditTasks = (u) => isLead(u);
export const canCloseTasks = (u) => isLead(u);
export const canChangeAISettings = (u) => isManager(u);
export const canRunAiTroubleshooting = (u, settings = {}) => isLead(u) || (roleFrom(u) === Roles.STAFF && settings.aiAllowStaffManualRerun === true);
export const canAnswerAiFollowups = (u) => isStaff(u);
export const canSaveFixToLibrary = (u, settings = {}) => isLead(u) || (roleFrom(u) === Roles.STAFF && settings.aiAllowStaffSaveFixesToLibrary === true);
